      ...
      <div>
        ...
        <div className="App">
          ...
          <div className="App-playlist">
            ...
            <Playlist playlistName={this.state.playlistName} playlistTracks={this.state.playlistTracks} onRemove={this.removeTrack} onNameChange={this.updatedPlaylistName}/>
          </div>
        </div>
      </div>
    )
